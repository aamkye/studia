...
- Miękiszowe
- Okrywające
  - Epiderma (skórka pędu, coś jak goretex - oddycha, ale chroni)
    - Funkcje:
      - wymiana gazowa
      - obronna
      - wydzielanie
    - Typy komórek:
      ...
      - komórki szparkowe
    - Wytwory epidermy
      - Kutikula (warstwa ochronna, forma wosku)
...
Pełni funkcję jak nazwa

## Tkanki twórcze

- Merystem wierzchołkowy pędu (wzrost w górę)
- Merystem wierzchołkowy korzenia (wzrost w dół)
- Merystem interkalarny (trawy)
- Kambium (wzrost wszerz)
- Fellogen
- Kallus
...
Utrata wody przez roślimy lądowe w postaci pary wodnej

- proces aktywny
- zachodzi przez aparaty szparkowe
  - 1-3% parowanie przez epidermę lub kutikula
  - 97-99% to transpiracja

# Morfologia funkcjonalna roślin

- układ fotosyntetyczny
...
- przytwierdzająca
- przewodząca
- zapasowa (rośliny dwuletnie, byliny, rośliny wieloletnie o pędach zdrewniałych)
- specjalne (czepne, oddechowe, ssawkowe)
...
- element pedu
- przewodzenie w pedzie wody i soli mineralnyc
- laczy korzenie z liscmi
- utrzymuje w odpowiednim polozeniu liscie kwiaty i owoce

### Budowa łodygi

kwiat, lisc, owoc, lodyga (korzen - ped)

xylem = drewno

roslina jednoliscienna
